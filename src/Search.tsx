...
const AutoComplete: React.FC<AutoCompleteProps> = ({ autoComplete, search }) => {
...
const Suggestion: React.FC<SuggestionProps> = ({ suggestion, onSuggestionClick }) => {
...
const PageControl: React.FC<PageControlProps> = ({ direction, onClick }) => (
  <button
...
const Results: React.FC<ResultProps> = ({ results, onPageLeft, onPageRight, onSelect }) => (

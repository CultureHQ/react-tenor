...
function (_Component) {
  ...
  function Tenor() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSearchChange", function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "performSearch", function (query) {
      ...
      return new _client.default(token).search(query).then(function (results) {
        _this.setState({
          results: results,
          searching: false
        });
